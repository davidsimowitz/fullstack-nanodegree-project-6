...
* Setup directory for application.
  ...
  $ cd flask
  ```
* Clone and rename the Coordinate Application.
  ```bash
  ...
  ```
* Create the client secret file and paste in the credentials from the Coordinate App project on Google Cloud Platform.
  ```bash
...
## Site Setup.
* Create Coordinate App configuration file:
  ```bash
  ...
  ```
* Create Coordinate App wsgi file:
  ```bash
...
## Disable the default site and enable the Coordinate App.
```bash
